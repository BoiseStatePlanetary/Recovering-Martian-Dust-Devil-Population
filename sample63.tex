...
As in previous work \citep[e.g.][]{2016JGRE..121.1514K}, we model the vortex signals as a modified Lorentzian profile $L(t)$:
\begin{equation}
    L(t) = \frac{-\Delta P}{1 + \left( \frac{ t - t_0 }{\Gamma/2} \right)^2},\label{eqn:Lorentzian_profile}
\end{equation}
where $t$ is the time of each datum, $\Delta P$ is the maximum value of the pressure excursion (a positive number) at the center of vortex signal, $t_0$ the central time, and $\Gamma$ the full-width/half-max for the profile. 

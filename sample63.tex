...
\begin{figure}
    ...
    \caption{The solid blue curve shows the areal occurrence rate for vortices (``vortex rates''). The dashed, orange line shows the allowed maximum rate for dust devils inferred from the image analysis (``max DD rates''). The dash-dot green line show the median rate reported in \citet{2020GeoRL..4787234P} (``P20 rate'').}

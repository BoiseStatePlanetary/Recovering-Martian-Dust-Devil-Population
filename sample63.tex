...
\begin{figure}
    ...
    \caption{(a) The number of vortices during each sol $N$ (blue dots). The orange histogram shows the same numbers with bins 35 sols wide. (b) The number of vortices during each hour local true solar time (LTST). Orange lines in both panels show Poisson error bars.}

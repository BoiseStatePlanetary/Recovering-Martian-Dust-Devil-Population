...
\end{equation}
where $t$ is the time of each datum, $t_0$ the time of closest approach ($r(t_0) = b$), $r$ is the radial distance from the vortex center, $P_{\rm act}$ the central pressure excursion, and $D_{\rm act}$ is taken as the vortex diameter. $r(t)$ is given by
\begin{equation}

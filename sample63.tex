...
Each image also has an effective integration time equal to the time for a dust devil to move through the region visible (assuming the lifetime of the dust devil is long by comparison). The maximum crossing time would be equal to the time for a dust devil to cross along the horizon, no farther away than $2.4\,{\rm km}$. With an FOV of $124^\circ$, this distance is $\pi \left(124^\circ/180^\circ\right) \left( 2.4\,{\rm km} \right) \approx 2.6\,{\rm km}$. The time to cross this distance will depend on the ambient wind speed, and so for our calculation, we will take the median wind speed during the observational period. 

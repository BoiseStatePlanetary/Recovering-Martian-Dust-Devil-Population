...
If all encountered vortices had the same diameter $D$, advective speed $U$, the number of vortices per unit area, which can be estimated from the number of vortex detections per unit time, $\nu$, via
\begin{equation}
    \nu = N U D. \label{eqn:simple_number_of_encounters}
\end{equation}

...
Analyzing the pressure time-series from the Insight lander, \citet{} reported an unprecedented number of vortex detections, 9,019 in all. Their detection scheme was simple: they sought dips in the pressure time-series $\Delta P$ with a magnitude greater than $0.3\,{\rm Pa}$ of a rolling average within a window 1000-seconds wide. Figure \ref{} illustrates the $\Delta P$-values and sol of all the vortices reported, along with the profiles of several examples.

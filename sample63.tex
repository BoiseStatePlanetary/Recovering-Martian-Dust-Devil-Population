...
The $\Delta P_{\rm obs}$ histogram (Figure \ref{fig:Pobsprime-sigmaP_vs_W} (c)) declines for $\Delta P_{\rm obs} < 1.13\,{\rm Pa}$, at least, in part, because of difficulty detecting these more shallow signals against the noise. 

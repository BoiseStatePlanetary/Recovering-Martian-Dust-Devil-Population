...
The $\Gamma_{\rm obs}$- and $\Delta P_{\rm obs}$-values exhibit intriguing trends as well. Figure \ref{fig:Gammaobs_DeltaPobs_vs_TOD_and_sol} (a) and (b) shows obvious statistically robust trends. On the other hand, Figure \ref{fig:Gammaobs_DeltaPobs_vs_TOD_and_sol} (c) shows that, binned by the hour, $\Gamma_{\rm obs}$ increases from $2$ to $20\,{\rm s}$ at a rate of $2\pm0.1\,{\rm s\ hr^{-1}}$. Figure \ref{fig:Gammaobs_DeltaPobs_vs_TOD_and_sol} (d) shows that $\Delta P_{\rm obs}$ peaks around 12:00 LTST at $1.4\,{\rm Pa}$ with minimum values at either end of about $0.7\,{\rm Pa}$.

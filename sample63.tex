...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/suppressed_DeltaPobs.png}
    \caption{Comparing the pressure excursion observed before $\Delta P_{\rm obs}$ application of the mean boxcar filter and after $\Delta P_{\rm obs}^\prime$ as a function of the width of the filter $W$ and of the vortex signal $\Gamma_{\rm obs}$.}
    \label{fig:suppressed_DeltaPobs}
\end{figure}

...
\begin{figure}
    ...
    \caption{(a) The number of vortices during each sol $N$. (b) The number of vortices during each hour local true solar time (LTST).}
    \label{fig:sol_and_t0_histograms}
\end{figure}

The vortices also show sol-to-sol and hour-to-hour variation. Figure \ref{fig:sol_and_t0_histograms} shows how the numbers ov roti

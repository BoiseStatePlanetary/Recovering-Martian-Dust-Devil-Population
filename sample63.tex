...
We can relate the areal occurrence rate, $n$, from the number of dust devils observed $k$ in an amount of time $t$:
\begin{equation}
   n = \frac{k}{t A_{\rm survey}} = \left( \frac{2 \alpha^2}{t \Delta_{\rm FOV} D^2} \right)\ k.
